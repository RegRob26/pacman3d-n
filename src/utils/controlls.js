...
exports.onKeyDown = exports.crearOrbitControls = void 0;
...
function crearOrbitControls(renderer) {
...
exports.crearOrbitControls = crearOrbitControls;
 ...
 * @param laberinto
 */
function onKeyDown(event, pacman, laberinto) {
    ...
    switch (event) {
        case 87: // Tecla "w"
            ...
            if ((0, colisiones_1.detectarColisionBarrera)(posicionNueva, laberinto))
                return;
