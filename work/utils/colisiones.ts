...
export function detectarColisionBarrera(pacman: any, maze: any) {
...
export function detectarColisionPunto(pacman: any, mazeObject: any, maze: any, scene: any, puntos: any){
  // Obtener la posición actual del pacman
